        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              ...
              Repellendus voluptatem earum assumenda soluta itaque aliquam,
              ducimus ipsam esse doloribus? Eveniet sed quae nesciunt ducimus
              quod.
            </p>
            {/* BIOGRAPHY QUOTE */}
          ...
          <div className="flex flex-col gap-12 justify-center pb-8">
            ...
            <div>
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  {/* JOB TITLE */}
                  <div className="font-semibold bg-white p-3 rounded-b-lg rounded-s-lg">
                    Senior Javascrip Engineer
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    My current position. Way better than the position before!
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 font font-semibold text-sm">
                    2024 - Present
                  </div>
                  {/* JOB COMPANY */}
                  <div className="bg-white rounded text-sm p-1 font-semibold w-fit">
                    Apple
                  </div>
                </div>
                {/* CENTER */}
